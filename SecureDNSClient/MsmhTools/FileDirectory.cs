...
namespace MsmhTools
{
    public class FileDirectory
    {
        ...
        public static double ConvertSize(double value, SizeUnits fromUnit, SizeUnits toUnit)
        {
            try
            {
                ...
                if (outString.Contains('.') && outString.EndsWith('0'))
                {
                    ...
                    return double.TryParse(outString, out double outValueNoZero) ? outValueNoZero : outValue;
                }
                else
                    return outValue;
            }

...
```
Mode Light: -p -r -s -m -e 40 -w
Mode Medium: -p -r -s -m -f 2 -e 40 -w
Mode High: -p -r -s -m -f 2 -e 40 -w --wrong-chksum --wrong-seq
Mode Extreme: -p -r -s -m -f 2 -e 40 -w --allow-no-sni --auto-ttl --wrong-chksum --wrong-seq --max-payload

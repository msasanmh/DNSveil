...
public static class EnumsAndStructs
{
    ...
    public struct GroupItem
    {
        ...
        public GroupItem(bool selected, bool builtIn, string name, GroupMode mode)
        {
            Selected = selected;
            BuiltIn = builtIn;
            Name = name;
    ...
    public struct GroupSettings
    {
        ...
        public GroupSettings(bool enabled, string lookupDomain, double timeoutSec, int parallelSize, IPAddress bootstrapIP, int bootstrapPort, int maxNumberOfServersToConnect, bool allowInsecure)
        {
            Enabled = enabled;

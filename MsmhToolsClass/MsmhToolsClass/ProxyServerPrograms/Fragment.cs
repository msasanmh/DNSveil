...
public partial class ProxyProgram
{
    public class Fragment
    {
        ...
        public class ProgramMode
        {
            ...
            private void Test(byte[] data, Socket socket, int beforeSniChunks, int sniChunks, int offset, Fragment bp)
            {
            ...
            private void SendDataInFragmentAllExtensions(byte[] data, Socket socket, int beforeSniChunks, int sniChunks, int offset, Fragment bp)
            {
            ...
            private void SendDataInFragmentSniExtension(byte[] data, Socket socket, int beforeSniChunks, int sniChunks, int offset, Fragment bp)
            {
            ...
            private void SendDataInFragmentSNI(byte[] data, Socket socket, int beforeSniChunks, int sniChunks, int offset, Fragment bp)
            {
            ...
            private List<byte[]> ChunkDataNormal(byte[] data, int chunks, int offset)
            {
            ...
            private List<byte[]> ChunkDataNormal2(byte[] data, int fragmentSize)
            {
            ...
            private List<byte[]> ChunkDataNormal3(byte[] data, int fragmentSize)
            {
            ...
            private List<byte[]> ChunkDataRandom(byte[] data, int fragmentChunks)
            {
            ...
            private void SendPackets(byte[] data, Socket socket, Fragment bp, List<byte[]> packets)
            {
                // Check packets
                int allLength = 0;

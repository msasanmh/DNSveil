...
namespace MsmhToolsClass
{
    public static class NetworkTool
    {
        ...
        public static void GetUrlDetails(string url, int defaultPort, out string scheme, out string host, out int port, out string path, out bool isIPv6)
        {
            url = url.Trim();
            scheme = string.Empty;
        ...
        {
            string ip = ipv4.Trim();
            return ip.Equals("0.0.0.0") || ip.StartsWith("10.") || ip.StartsWith("127.0.") || ip.StartsWith("172.16.") || ip.StartsWith("192.168.");
        }

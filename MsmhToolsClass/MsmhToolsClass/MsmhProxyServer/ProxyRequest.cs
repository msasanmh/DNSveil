...
public class ProxyRequest
{
    ...
    public static async Task<ProxyRequest?> RequestHttpRemote(byte[] firstBuffer)
    {
        try
        {
    ...
    public static async Task<ProxyRequest?> RequestSocks4Remote(ProxyClient client, byte[] firstBuffer)
    {
        try
        {
    ...
    public static async Task<ProxyRequest?> RequestSocks5Remote(ProxyClient client, byte[] firstBuffer)
    {
        try
        {
            // Get Version

...
public class WpfSplitPanelVL : Control
{
    [Category("Brush")]
    ...
    public static readonly DependencyProperty SplitterBrushProperty =
        DependencyProperty.Register(nameof(SplitterBrush), typeof(Brush), typeof(WpfSplitPanelVL),
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(WpfSplitPanelVL),
    ...
    public static readonly DependencyProperty HeaderProperty =
        DependencyProperty.Register(nameof(Header), typeof(string), typeof(WpfSplitPanelVL), new PropertyMetadata(nameof(WpfSplitPanelVL)));
    ...
    public static readonly DependencyProperty Panel1Property =
        DependencyProperty.Register(nameof(Panel1), typeof(object), typeof(WpfSplitPanelVL), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty Panel2Property =
        DependencyProperty.Register(nameof(Panel2), typeof(object), typeof(WpfSplitPanelVL), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty FixedPanelProperty =
        DependencyProperty.Register(nameof(FixedPanel), typeof(bool), typeof(WpfSplitPanelVL), new PropertyMetadata(false));
    ...
    public static readonly DependencyProperty IsOpenProperty =
        DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(WpfSplitPanelVL),
            new PropertyMetadata(false, OnIsOpenChanged));

    private static async void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is WpfSplitPanelVL panelVL)
        {
            await panelVL.UpdatePositionAsync(true);
        }
    }
    ...
    private static readonly DependencyProperty Panel1PercentProperty =
        DependencyProperty.Register(nameof(Panel1Percent), typeof(int), typeof(WpfSplitPanelVL),
    ...
    public WpfSplitPanelVL()
    {
        ...
        Loaded -= WpfSplitPanelVL_Loaded;
        Loaded += WpfSplitPanelVL_Loaded;
    }

    private async void WpfSplitPanelVL_Loaded(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            PART_TextBlock.SetValue(Canvas.LeftProperty, eX + 7);
    ...
    private async Task ToMiddleAsync()
    {
        try
        {
            ...
            PART_MainGrid.ColumnDefinitions[0].Width = GridLength.Auto;
        }
        catch (Exception) { }
    }

    private async Task MiddleToLeftAsync()
    {
        try
        {
            if (PART_MainGrid == null) return;
            ...
            if (DesignerProperties.GetIsInDesignMode(this))
                PART_MainGrid.ColumnDefinitions[0].Width = new GridLength(0);
        }
        catch (Exception) { }
    }
    ...
    private async Task RightToLeftAsync()
    {
        try
        {
            ...
            for (int n = 0; n <= 100; n++)
            {
                ...
                PART_MainGrid.ColumnDefinitions[0].Width = new GridLength(100 - n, GridUnitType.Star);
                PART_MainGrid.ColumnDefinitions[2].Width = new GridLength(n, GridUnitType.Star);
                await Task.Delay(1);
            }
    ...
    private async Task UpdatePositionAsync(bool animate)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    PART_MainGrid.ColumnDefinitions[0].Width = GridLength.Auto;
                    PART_MainGrid.ColumnDefinitions[2].Width = new GridLength(1, GridUnitType.Star);
                }
                else
                {
                    PART_MainGrid.ColumnDefinitions[0].Width = new GridLength(0, GridUnitType.Star);
                    PART_MainGrid.ColumnDefinitions[2].Width = new GridLength(100, GridUnitType.Star);

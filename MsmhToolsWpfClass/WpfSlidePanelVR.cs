...
public class WpfSlidePanelVR : Control
{
    [Category("Brush")]
    ...
    public static readonly DependencyProperty SplitterBrushProperty =
        DependencyProperty.Register(nameof(SplitterBrush), typeof(Brush), typeof(WpfSlidePanelVR),
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(WpfSlidePanelVR),
    ...
    public static readonly DependencyProperty HeaderProperty =
        DependencyProperty.Register(nameof(Header), typeof(string), typeof(WpfSlidePanelVR), new PropertyMetadata(nameof(WpfSlidePanelVR)));
    ...
    public static readonly DependencyProperty Panel1Property =
        DependencyProperty.Register(nameof(Panel1), typeof(object), typeof(WpfSlidePanelVR), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty Panel2Property =
        DependencyProperty.Register(nameof(Panel2), typeof(object), typeof(WpfSlidePanelVR), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty IsOpenProperty =
        DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(WpfSlidePanelVR),
            new PropertyMetadata(false, OnIsOpenChanged));

    private static async void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is WpfSlidePanelVR panelVR)
        {
    ...
    public WpfSlidePanelVR()
    {
        ...
        Loaded -= WpfSlidePanelVR_Loaded;
        Loaded += WpfSlidePanelVR_Loaded;
    }

    private async void WpfSlidePanelVR_Loaded(object sender, RoutedEventArgs e)
    {
    ...
    private async Task UpdatePositionAsync(bool animate)
    {
        try
        {
            ...
            MinWidth = PART_Content2Grid.ActualWidth;

            double slideWidth = PART_Content2Grid.ActualWidth - PART_SplitterBorder.ActualWidth;
            double from = PART_TransformContent2.X;
            ...
            if (animate)
            {
                if (IsOpen)
                {
                    ...
                    Task animSlide = PART_Content2Grid.AnimSlideHAsync(to, AnimDurationMS);

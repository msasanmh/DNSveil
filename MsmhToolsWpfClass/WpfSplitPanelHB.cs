...
public class WpfSplitPanelHB : Control
{
    [Category("Brush")]
    ...
    public static readonly DependencyProperty SplitterBrushProperty =
        DependencyProperty.Register(nameof(SplitterBrush), typeof(Brush), typeof(WpfSplitPanelHB),
    ...
    public static readonly DependencyProperty CornerRadiusProperty =
        DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(WpfSplitPanelHB),
    ...
    public static readonly DependencyProperty HeaderProperty =
        DependencyProperty.Register(nameof(Header), typeof(string), typeof(WpfSplitPanelHB), new PropertyMetadata(nameof(WpfSplitPanelHB)));
    ...
    public static readonly DependencyProperty Panel1Property =
        DependencyProperty.Register(nameof(Panel1), typeof(object), typeof(WpfSplitPanelHB), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty Panel2Property =
        DependencyProperty.Register(nameof(Panel2), typeof(object), typeof(WpfSplitPanelHB), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty FixedPanelProperty =
        DependencyProperty.Register(nameof(FixedPanel), typeof(bool), typeof(WpfSplitPanelHB), new PropertyMetadata(false));
    ...
    public static readonly DependencyProperty IsOpenProperty =
        DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(WpfSplitPanelHB),
            new PropertyMetadata(false, OnIsOpenChanged));

    private static async void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is WpfSplitPanelHB panelHB)
        {
    ...
    private static readonly DependencyProperty Panel1PercentProperty =
        DependencyProperty.Register(nameof(Panel1Percent), typeof(int), typeof(WpfSplitPanelHB),
    ...
    public WpfSplitPanelHB()
    {
        ...
        Loaded -= WpfSplitPanelHB_Loaded;
        Loaded += WpfSplitPanelHB_Loaded;
    }

    private async void WpfSplitPanelHB_Loaded(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            PART_TextBlock.SetValue(Canvas.TopProperty, eY - 2);
    ...
    private async Task ToMiddleAsync()
    {
        try
        {
            ...
            PART_MainGrid.RowDefinitions[2].Height = GridLength.Auto;
        }
        catch (Exception) { }
    }
    ...
    private async Task MiddleToBottomAsync()
    {
        try
        {
            ...
            if (DesignerProperties.GetIsInDesignMode(this))
                PART_MainGrid.RowDefinitions[2].Height = new GridLength(0);
        }
        catch (Exception) { }
    }

    private async Task TopToBottomAsync()
    {
        try
        {
            if (PART_MainGrid == null) return;
    ...
    private async Task UpdatePositionAsync(bool animate)
    {
        try
        {
            ...
            else
            {
                if (IsOpen)
                {
                    PART_MainGrid.RowDefinitions[0].Height = new GridLength(1, GridUnitType.Star);
                    PART_MainGrid.RowDefinitions[2].Height = GridLength.Auto;
                }
                else
                {
                    PART_MainGrid.RowDefinitions[0].Height = new GridLength(100, GridUnitType.Star);
                    PART_MainGrid.RowDefinitions[2].Height = new GridLength(0, GridUnitType.Star);
